...
4. **Draft with `keru-writing-tickets`.** Invoke that skill to produce the ticket text as its gated deliverable (`~/.claude/keru-deliverables/keru-deliverable-writing-tickets-<id>.md`). Do not hand-write the ticket here.
