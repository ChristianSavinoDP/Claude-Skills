...
config/hooks.json      global hooks (require-skill/check-output/judge-output Stop gates, deliverable-write gate, Bash command gate (fast static + model fallback), inline-interp block, WebFetch block)
