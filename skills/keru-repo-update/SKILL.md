...
5. Report what happened per repo, leading with anything that needs the user:
   ...
   - Repos **skipped** (`diverged-skipped`, `ff-failed`, `checkout failed`): name why so the user can resolve by hand.
